...
public sealed class QrVersion
{
    ...
    private QrVersion(int versionNumber, int[] alignmentPatternCenters, params ECBlocks[] ecBlocks)
    {
        ...
        ECB[] ecbArray = ecBlocks[0].Blocks;
        int total = 0;
    ...
    internal static QrVersion FromVersionNumber(int versionNumber)
    {
        if (!IsValidVersionNumber(versionNumber))
        {
            throw new ArgumentException(null, nameof(versionNumber));
        }
    ...
    private static QrVersion[] CreateQrVersions()
    {
        return
           [
               new QrVersion(1, [],
               ...
               new QrVersion(21, [6, 28, 50, 72, 94],
               ...
               new QrVersion(24, [6, 28, 54, 80, 106],
               ...
               new QrVersion(25, [6, 32, 58, 84, 110],
               ...
               new QrVersion(26, [6, 30, 58, 86, 114],
               ...
               new QrVersion(27, [6, 34, 62, 90, 118],
               ...
               new QrVersion(28, [6, 26, 50, 74, 98, 122],
               ...
               new QrVersion(29, [6, 30, 54, 78, 102, 126],
               ...
               new QrVersion(30, [6, 26, 52, 78, 104, 130],
               ...
               new QrVersion(31, [6, 30, 56, 82, 108, 134],
               ...
               new QrVersion(32, [6, 34, 60, 86, 112, 138],
               ...
               new QrVersion(33, [6, 30, 58, 86, 114, 142],
               ...
               new QrVersion(34, [6, 34, 62, 90, 118, 146],
               ...
               new QrVersion(35, [6, 30, 54, 78, 102, 126, 150],
               ...
               new QrVersion(36, [6, 24, 50, 76, 102, 128, 154],
               ...
               new QrVersion(37, [6, 28, 54, 80, 106, 132, 158],
               ...
               new QrVersion(38, [6, 32, 58, 84, 110, 136, 162],
               ...
               new QrVersion(39, [6, 26, 54, 82, 110, 138, 166],
               ...
               new QrVersion(40, [6, 30, 58, 86, 114, 142, 170],
