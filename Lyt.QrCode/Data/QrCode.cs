...
internal sealed partial class QrCode: IPixelProvider
{
    ...
    internal const int MaxVersion = 40;
    ...
    /// <summary> The error correction level used for this QR code. </summary>
    internal ErrorCorrectionLevel ErrorCorrectionLevel { get; } = ErrorCorrectionLevel.Medium;
